...
class MiscSettingsSubState extends BaseOptionsMenu
{
  public function new()
  {
    ...
    final option:Option = new Option('Use JS Engine Recharts', // Name
    ...
    final option:Option = new Option('Always Play Cutscenes', // Name
    ...
    final option:Option = new Option('Disable Splash Screen', // Name
    ...
    final option:Option = new Option('Rainbow Note Shift Speed', // Name
    ...
    final option:Option = new Option('Autosave', 'If checked, the Chart Editor will autosave.', 'autosaveCharts', 'bool', true);
    addOption(option);

    final option:Option = new Option('Autosave Time: ', 'Change the amount of time for a chart to autosave.', 'autosaveTime', 'int', 240);
