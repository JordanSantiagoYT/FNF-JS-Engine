...
class NoteOffsetState extends MusicBeatState
{
  ...
  override public function create()
  {
    ...
    {
      final numScore:FlxSprite = new FlxSprite(43 * daLoop).loadGraphic(Paths.image('ratings/default/num' + i));
  ...
  override public function update(elapsed:Float)
  {
    ...
    if (onComboMenu)
    {
      ...
      if (holdingObjectType != null)
      {
        ...
        {
          final mousePos:FlxPoint = FlxG.mouse.getScreenPosition(camHUD);
  ...
  function createTexts()
  {
    for (i in 0...4)
    {
      final text:FlxText = new FlxText(10, 48 + (i * 30), 0, '', 24);
